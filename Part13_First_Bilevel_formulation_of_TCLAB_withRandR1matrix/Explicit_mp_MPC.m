...
y0(1)=340; %IC FOR THIRD SUB-CASESTUDY
y0(2)=315 ;
...
%     end
    ...
    theta1 = [xSSp y0-ynominal ysp-ynominal umat(end,2)]; % 
 ...
 %   uaux1 = 0;
    theta2=[xSSp uaux1 y0-ynominal ysp-ynominal umat(end,2)];
