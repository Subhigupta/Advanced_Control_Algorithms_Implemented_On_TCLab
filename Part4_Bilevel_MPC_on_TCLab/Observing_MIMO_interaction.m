...
%steady_state temperatures obtained are 314.44 K and 311.14 K
T1_measured_initial=T1(end,1);
T2_measured_initial=T2(end,1);
ynominal=[T1_measured_initial T2_measured_initial];
unominal=[30 30];

save ynominal.mat ynominal;
save unominal.mat unominal;
format long
%% 
...
%Giving step test to heater 2 while keeping heater 1 level constant
Q2(1:60*60)=30;
Q2(60*60:n)=0.5*30;%giving step input at t=60 min
...
save data2.mat T_predicted_matrix Q_matrix
%% 
