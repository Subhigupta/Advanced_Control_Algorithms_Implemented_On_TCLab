...
weighted_coefficient1_R1= 1; %0.001;
weighted_coefficient2_R1= 1; %0.01;
...
mpc_crystal.OH = 5; %10 %how many looks into the future for error minimzation
mpc_crystal.NC = 5;%10  % how many future control actions
