...
weighted_coefficient1_R1 = 300;%0.005;%1; %100%0.001;
weighted_coefficient2_R1 = 10;
% mpc_crystal.R = 0.001*eye(size(model_crystal.B,2)); %Weight matrix for output moves (∆u)
mpc_crystal.R1 =blkdiag(weighted_coefficient1_R1,weighted_coefficient2_R1); %Weight matrix for output moves (∆u)

%% 
weighted_coefficient_1 = 0.0001/1000;
weighted_coefficient_2 = 0.0001/1000;
