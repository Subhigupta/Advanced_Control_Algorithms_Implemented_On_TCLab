...
%     end
    ...
    theta1 = [xSSp y0-ynominal ysp-ynominal umat(end,1)]; % 
    
   [nCR1,uaux2] = PointLocation(Final,theta1');
   %[uaux,fval,exitflag] = cplexqp(2*problem.Q, problem.Ht*theta'+problem.c, problem.A, problem.b+problem.F*theta');
%     uaux1 = 0;
    theta2=[xSSp uaux2 y0-ynominal ysp-ynominal umat(end,1)];
    [ncR2,uaux1]= PointLocation(Solution,theta2');
    uaux=[uaux1;uaux2];
